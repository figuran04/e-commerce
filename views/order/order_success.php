...
<h2 class="text-2xl font-bold text-lime-500">✅ Berhasil!</h2>
...
<div class="mt-4">
  <a href="../home" class="px-4 py-2 rounded">🏠 Kembali ke Beranda</a>
  <a href="../../controllers/orders/fetch_orders.php" class="bg-lime-500 text-white px-4 py-2 rounded">📜 Lihat Riwayat Pesanan</a>
</div>
