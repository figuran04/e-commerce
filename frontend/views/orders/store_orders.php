...
<div class="space-y-6">
  <div class="flex flex-col justify-between md:items-center md:flex-row">
    ...
    <a href="/views/orders/user_orders.php" class="text-right hover:underline hover:text-lime-700">ke pesanan saya <i class="ph ph-arrow-right"></i></a>
  </div>
        ...
        <div class="p-4 border-[3px] rounded-lg shadow-sm border-<?= $statusColor  ?> bg-white">
          ...
          <div class="grid gap-4 md:grid-cols-2">
            <?php foreach ($order['items'] as $item): ?>
              <a href="/views/product_detail/?id=<?= $item['product_id'] ?>" class="transition-all rounded-lg hover:bg-gray-100 group">
