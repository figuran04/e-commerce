          ...
          <tbody class="divide-y">
            <?php foreach ($products as $product) : ?>
              <tr class="border-gray-200">
                <td class="px-4 my-2">
                  <a href="/views/product_detail/?id=<?= $product['id'] ?>" class="text-sm hover:underline line-clamp-3"><?= htmlspecialchars($product['name']) ?></a>
                </td>
                <td class="px-4 py-2">
                ...
                <td class="px-4 py-2 space-x-2 truncate">
                  ...
                  <?php else : ?>
                    <a href="/views/product_detail/?id=<?= $product['id'] ?>" class="text-lime-600 hover:underline">Lihat detail</a>
                  <?php endif; ?>
                </td>
              </tr>
            <?php endforeach; ?>
          ...
          <div class="overflow-hidden transition bg-white rounded-lg shadow hover:shadow-md">
            ...
            <div class="flex flex-col p-2 mb-1 space-y-1">
              <h3 class="text-sm md:text-base font-medium text-gray-900 leading-snug line-clamp-2 h-[2.5rem] md:h-[3rem]">
                <a href="/views/product_detail/?id=<?= $product['id'] ?>" class="hover:underline"><?= htmlspecialchars($product['name']) ?></a>
              </h3>
              ...
              <div class="flex justify-end gap-2">
                ...
                <?php else : ?>
                  <a href="/views/product_detail/?id=<?= $product['id'] ?>" class="text-sm text-lime-600 hover:underline">Lihat detail</a>
                <?php endif; ?>
              </div>
            </div>
          </div>
